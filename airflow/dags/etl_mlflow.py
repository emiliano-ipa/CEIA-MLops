...
def etl_mlflow():
    ...
    def run_etl(local_csv_path: str):
        ...
        with mlflow.start_run(run_name="EDA_Run"):
            ...
            mlflow.log_param("dropped_columns", ["Employee ID", "Date of Joining", "Years in Company"])
            mlflow.log_param("categorical_columns", ["Gender", "Company Type", "WFH Setup Available"])
